      ...
      <main className="main-content">
        ...
        <header className="dashboard-header">
          <div className="header-left">
            ...
            <p className="dashboard-subtitle">Stay informed about your energy consumption and system status</p>
          </div>
          ...
          <div className="chatbot-container">
            ...
            <div className="chatbot-messages">
              <div className="message ai-message">
                <p>I can help you understand your alerts and provide recommendations to optimize your energy usage. What would you like to know?</p>
              </div>
            </div>
